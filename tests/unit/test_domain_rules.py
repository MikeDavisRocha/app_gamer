...
def test_game_entity_creation():
    ...
    """
    game = Game(id=1, name="The Legend of Zelda", console_id=99, created_at=None, updated_at=None)
...
def test_console_entity_creation():
    ...
    Teste Unitário Puro (Domínio).
    """
    console = Console(id=1, name="Switch", company="Nintendo", created_at=None, updated_at=None, deleted_at=None)
